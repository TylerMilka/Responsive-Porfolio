...
// Stock prices
var iagStockPrices = [1.42, 1.32, 1.45, 1.20, 1.34, 1.74, 1.10, 1.89, 1.42, 1.90];
...
function biggestProfit(stockArray, sharesBought) {
  ...
  if (stockArray.length > 2) {
    ...
    // Set initial minPrice, you can't buy any earlier than the first value.
...
// Call the function.
console.log(biggestProfit(iagStockPrices, 10000));
